...
public class Hasil extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// ---------------------------
		final TextView tvNama = (TextView) findViewById(R.id.showNama);
		final TextView tvJK = (TextView) findViewById(R.id.showJK);
		final TextView tvHarta = (TextView) findViewById(R.id.RpJumlah);
		final TextView tvHutang = (TextView) findViewById(R.id.RpHutang);
		final TextView tvPengurusanJenazah = (TextView) findViewById(R.id.RpPengurusanJenazah);
		final TextView tvWasiat = (TextView) findViewById(R.id.RpWasiat);
		final TextView tvJumlah = (TextView) findViewById(R.id.RpTotal);
		...
		final TextView AnakLakilaki1 = (TextView) findViewById(R.id.AnakLakilaki1);
		final TextView AnakPerempuan1 = (TextView) findViewById(R.id.AnakPerempuan1);

		final TextView Suami1 = (TextView) findViewById(R.id.Suami1);
		final TextView Istri1 = (TextView) findViewById(R.id.Istri1);

		final TextView Ayah1 = (TextView) findViewById(R.id.Ayah1);
		final TextView Ibu1 = (TextView) findViewById(R.id.Ibu1);
		
		final TextView Kakek1 = (TextView) findViewById(R.id.Kakek1);
		final TextView Nenek1 = (TextView) findViewById(R.id.Nenek1);
		
		final TextView SaudaraKandung1 = (TextView) findViewById(R.id.SaudaraKandung1);
		final TextView SaudariKandung1 = (TextView) findViewById(R.id.SaudariKandung1);
