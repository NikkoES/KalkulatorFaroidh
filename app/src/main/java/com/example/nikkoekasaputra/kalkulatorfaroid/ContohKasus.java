...
public class ContohKasus extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		TextView con1 = (TextView) findViewById(R.id.textViewContoh1);
		TextView con2 = (TextView) findViewById(R.id.textViewContoh2);
		TextView con3 = (TextView) findViewById(R.id.textViewContoh3);
		TextView con4 = (TextView) findViewById(R.id.textViewContoh4);
		TextView con5 = (TextView) findViewById(R.id.textViewContoh5);
